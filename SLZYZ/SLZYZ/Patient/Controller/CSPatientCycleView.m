...
#import "CSPatientCycleView.h"
#import "SDCycleScrollView.h"
#import "CSPatientLuoBoTool.h"
@interface CSPatientCycleView ()<SDCycleScrollViewDelegate>


@end
@implementation CSPatientCycleView

- (void)viewDidLoad{
        self.view.frame = CGRectMake(0, 0, kScreenWidth, kScreenHeight / 5 );
    NSLog(@"dfdfdfd");
    // 情景二：采用网络图片实现
